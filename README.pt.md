...
> Sistema completo de controle de estoque construído com Go, Gin, PostgreSQL e Vue 3.
...
- Indicador visual de estoque baixo (`quantidade <= estoque_minimo`)
...
- Atualização automática do estoque via transação SQL
